...
export interface Coverage {
  demanda: number;
  capacidadeGarantida: number;
  coberturaPercentual: number;
  deficitCestas: number;
...
export interface Dashboard {
  ...
  proximaDistribuicao: {
    ...
    checkIns: number;
    retiradas: number;
    cestasMontadasCompativeis: number;
    cestasLiberadas: number;
  } | null;
  saude: {
    proximaDistribuicao: Coverage;
    competenciaAtual: Coverage;
    competenciaSeguinte: Omit<Coverage, 'deficitCestas'> | null;
  };
  competenciaAtual: {
    id: string | null;
    competencia: string;
  ...
  estoque: {
    ...
    cestasMontadas: number;
    cestasReservadasParaDistribuicoes: number;
  };
